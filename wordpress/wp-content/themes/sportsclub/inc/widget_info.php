...
class SC_Widget_Info extends WP_Widget {
  public function __construct(){
    parent::__construct(
      'sc_widget_info',
      'SportsClub - виджет информация ',
      [
        'name' =>  'SportsClub - виджет информация',
        'description' => 'Выводит информацию о спорт клубе, используется в контактах под картой'
      ]
    );
  }
...
?>
    <a 
      href="mailto:<?php echo $instance['info'];?>" 
      class="widget-email">
      <?php echo $instance['info'];?> 
    </a>
<?php
